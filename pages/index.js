...
const TRUMP_SAID = [
  ...
  {
    date: 'May 5, 2026',
    said: '"No, the ceasefire is not over. Ultimately, this is a separate and distinct project, and we expected there would be some, some churn at the beginning, which happened." — Defense Secretary Pete Hegseth, Pentagon press briefing.',
    reality: 'Same press briefing, same room: JCS Chair Gen. Dan Caine confirms Iran has attacked US forces "more than 10 times" since the April 8 ceasefire was announced. The day before, US Navy helicopters destroyed six-to-seven Iranian small boats in the Strait of Hormuz — first US-initiated kinetic kills since the ceasefire. Iran fired cruise missiles, drones, and small boats at US-flagged vessels. UAE was struck by Iranian drones; Fujairah Oil Industry Zone caught fire; three Indian nationals injured. Israeli Iron Dome battery operated in Emirati airspace, intercepting Iranian projectiles. UAE called it a "dangerous escalation" and "unacceptable transgression." Saudi Crown Prince called UAE in solidarity. CNN-confirmed Israeli source: US-Israel are preparing for a "short campaign" to pressure Iran. Senior US officials a day prior: "closer to resumption of major combat operations than 24 hours ago." A ceasefire that includes 10+ attacks, US helicopter gunship action, missiles fired at US warships, an attacked Gulf ally, an Iron Dome battery active in foreign airspace, and joint operational planning for a "short campaign" is, definitionally, not a ceasefire. The administration has now reached the point of redefining the word rather than acknowledging the state. Trump in the Oval Office, asked what would constitute a violation: "You\'ll find out." Day 67.',
  },
];
