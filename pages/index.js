...
{ date: 'Mar 30', tier: 'critical', label: 'Trump tells the Financial Times: "Maybe we take Kharg Island, maybe we don\'t. We have a lot of options." Then: "It would also mean we had to be there [on Kharg Island] for a while." Brent rises 3.5% to $116+ on the statement — market repricing a ground invasion premium. Iran has been reinforcing Kharg for weeks. Australian Strategic Policy Institute: "The Iranians can probably sit back and attack Americans on Kharg Island, and casualties will mount up." Trump is publicly weighing a ground invasion of Iran\'s primary oil export hub in the same interview where he claims a deal is imminent. Day 31.' },
  ...
  { date: 'Apr 27', tier: 'today', label: 'Iran offers to reopen Hormuz if US lifts naval blockade and agrees to end war — nuclear program talks deferred to later phase. Two regional officials confirm to AP. Trump plans NSC meeting on proposal. No public response yet. Day 59.' },
  { date: 'Apr 27', tier: 'today', label: 'Araghchi meets Putin in St. Petersburg. Putin: confirms Russia will maintain intelligence ties with Tehran, hails Iran fighting "courageously and heroically," extends wishes for Mojtaba Khamenei\'s health. Russia-Iran strategic alignment hardening. Day 59.' },
  { date: 'Apr 27', tier: 'today', label: 'Brent ~$108.36 (+3%), WTI ~$96.85 (+2.6%) — highest in 3 weeks. Goldman Sachs raises Brent Q4 forecast to $90 (from $80). Trump: war could "come to an end very soon." White House: will "not negotiate through the press" on Hormuz deal offer. Day 59.' },
];
