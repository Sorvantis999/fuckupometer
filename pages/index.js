...
{ date: 'Mar 30', tier: 'critical', label: 'Trump tells the Financial Times: "Maybe we take Kharg Island, maybe we don\'t. We have a lot of options." Then: "It would also mean we had to be there [on Kharg Island] for a while." Brent rises 3.5% to $116+ on the statement — market repricing a ground invasion premium. Iran has been reinforcing Kharg for weeks. Australian Strategic Policy Institute: "The Iranians can probably sit back and attack Americans on Kharg Island, and casualties will mount up." Trump is publicly weighing a ground invasion of Iran\'s primary oil export hub in the same interview where he claims a deal is imminent. Day 31.' },
  ...
  { date: 'Apr 18', tier: 'today', label: 'Iran re-closes Strait of Hormuz. US refuses to lift naval blockade; Iran says it has "regained control" of the strait within hours of yesterday\'s opening. The 24-hour Hormuz window closes. Day 50.' },
  { date: 'Apr 18', tier: 'today', label: 'Rubio urges European allies to reimpose sanctions on Iran urgently, warning Tehran is approaching nuclear weapons capability. Also signals Iran may retain civilian nuclear energy program in final deal. Day 50.' },
  { date: 'Apr 18', tier: 'today', label: 'No date confirmed for second Islamabad round. Pakistan: talks still in channel, delegations unconfirmed. Ceasefire expires April 21 — 3 days. Oil rebounds sharply from yesterday\'s -10% drop on Hormuz re-closure. Day 50.' },
];
